...
public class EmployeeController {
    ...
    @GetMapping("/add")
    public Employee addEmployee(@RequestParam("name") String name, @RequestParam("surname") String surname, @RequestParam("departmentID") int departmentID, @RequestParam("salary") int salary) {
        return employeeService.addEmployee(name, surname, departmentID, salary);
    }

    @GetMapping("/remove")
    public Employee deleteEmployee(@RequestParam("name") String firstName, @RequestParam("surname") String lastName) {
        return employeeService.deleteEmployee(firstName, lastName);
    }

    @GetMapping("/find")
    public Employee findByName(@RequestParam("name") String firstName, @RequestParam("surname") String lastName) {
